...
% 10/2021. JJS. This version (ver4) can take a list of sessions (fd) and specific cells to plot (fc) so as to only plot cells within a certain category (say, 'symmetric').
