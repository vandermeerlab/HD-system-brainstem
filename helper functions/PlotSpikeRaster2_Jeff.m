function h = PlotSpikeRaster2_Jeff(cfg_in,S_in)
%% Plot spikes
...
if  nTrials == 1
    ...
    for iC = 1:nCells
        ...
        yvals = [ cfg.yMultiplier * iC - 2 - cfg.SpikeHeight.*ones(1,nSpikes);...
            cfg.yMultiplier * iC - 2 + cfg.SpikeHeight.*ones(1,nSpikes) ; nan(1,nSpikes) ];   % 2023-06-23. Spacing the rows for each neuron further apart. 
