function [PETH, outputS, outputT, outputI] = spike_PETH(S,t,varargin)
...
% JJS. 2021-03-05. Modified to work with vdM lab code. 
%--------------------------
% parameters
%--------------------------
window = [-2 5];
...
% 	I0 = data(ISI.restrict(t(iT)+window(1), t(iT)+window(2)));
    S0 = restrict(S, t(iT)+window(1), t(iT)+window(2));
	I0 = restrict(ISI, t(iT)+window(1), t(iT)+window(2));
