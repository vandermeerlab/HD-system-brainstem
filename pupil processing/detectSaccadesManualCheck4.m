...
overwrite = 1;
if exist(strcat(SSN, '-saccades.mat')) == 2
    f = input('-saccades.m already exists. Do you want to overwrite the existing file, or append? [o/a]', 's');
    if strcmp(f, 'o')
...
save(strcat(SSN, '-saccades.mat'), 'numtemporalSaccades', 'numnasalSaccades', 'temporalSaccades', 'nasalSaccades', 'combinedSaccades', 'temporalAmplitudes', 'nasalAmplitudes', 'tsdH', 'tsdV', 'diffH', 'diffV', 'amp1tsd', 'amp2tsd', 'XS_Remove', 'YS_Remove', 'XS_Add', 'YS_Add', 'cfg', 'Button', 'AHV_tsd', 'tstart', 'tend', 'tvec');
