function output = vec_to_state(up_down_tsd) %better vector names

%create empty state vector
state_vec = zeros(length(up_down_tsd.tvec), 1); 
...
disp('after the loop, the state vector is') %debugging
state_vec
